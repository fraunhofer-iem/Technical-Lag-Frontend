...
import {FilterCloseButtonStyles} from "./FilterCloseButtonStyles.ts";

const FilterCloseButton: React.FC<ButtonProps> = ({text, action, tooltip}) => {
    const [isHovered, setIsHovered] = useState<boolean>(false);
    const theme = useTheme();

    const filterButtonStyle = {
        ...FilterCloseButtonStyles.filterButton,
